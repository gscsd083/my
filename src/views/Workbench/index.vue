      ...
      <info-wrapper title="园区数据">
        <div class="pard-data">
          <div class="item">
            ...
            <span class="value">{{
              detail.annualIncome ? detail.annualIncome : '--'
            }}</span>
          </div>
          <div class="item">
            <span class="label">入驻企业总数（个）</span>
            <span class="value">{{
              detail.enterpriseTotal ? detail.enterpriseTotal : '--'
            }}</span>
          </div>
          <div class="item">
          ...
          <div class="item">
            ...
            <span class="value">{{
              detail.chargePoleTotal ? detail.chargePoleTotal : '--'
            }}</span>
          </div>
        </div>
      </info-wrapper>
...
export default {
  ...
  methods: {
    goBigScreen() {
      window.location.assign('http://127.0.0.1:5173/big-screen')
    },
    async getInfo() {
